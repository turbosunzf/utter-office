# utter-office（AI 秘书）移动端 PRD —— v1.8 归档

> **已归档 · 2026-08-21**  
> 本文为 v1.8「AI 秘书」叙事完整规格，**不再作为现行产品真源**。  
> 现行请改读：  
> - [`product-blueprint-v2.md`](./product-blueprint-v2.md)  
> - [`app-prd.md`](./app-prd.md)（v2 · 数字员工 · Context 作战台）  
> 保留本文供接口细表、历史核验与对照。
